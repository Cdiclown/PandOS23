...
#define ALLOFF      0x00000000 // tutti i bit spenti
#define USERPON     0x00000008 // KUp, stato precedente di KUc
#define IEPON       0x00000004 // IEp, stato precedente di IEc
#define IECON       0x00000001 // IEc, global interrupt enable (quando acceso accetta gli interrupt scelti dalla interrupt mask)
#define IMON        0x0000FF00 // IM, interrupt mask (0xFF00 accetta tutti gli interrupt)
#define TEBITON     0x08000000 // TE, processor local timer enable
#define DISABLEINTS 0xFFFFFFFE // tutti i bit accesi tranne IEc
